...
parser.add_argument('--save', action="store_true", help='Save game to file (for ML-based solutions)')
parser.add_argument('--save_match', action="store_true", help='Save game to directory (for replaying later)')
parser.add_argument('--load_match', type=str, metavar = "match_dir", help='Directory containing the match to load', default="")
